...
#  obs   - value of observer for averaging (a value of 3 means duplicates)
#  model  - model object 
#
...
#
#  Note: this routine could benefit from changes made to predict.io (pdot=FALSE); need to do same for
#  predict.trial.
#
{
  xgrid=NULL
