...
#
   ...
   {
      errors(paste("Break points are out of order."))
      stop()
   }
#
...
#
   ...
   {
       errors(paste("Specified endpoints > ",width,"; values reset."))
...
#
   ...
   {
      errors(paste("Last interval endpoint did not include", width,". It was reset."))
...
#
   ...
   {
       errors(paste("Specified endpoints < ",left,"; values reset."))
...
#
   ...
   {
      errors(paste("First interval endpoint did not include,",left, ". It was reset"))
