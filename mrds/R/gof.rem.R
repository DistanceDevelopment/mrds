...
#
# gof.rem - Computes chi-square gof test for rem models
#
# Arguments: 
#
...
#
#  Functions used: predict(predict.rem)
#
{
	...
	n=nrow(xmat)
#
#   Set up omega index; 1 - detected by primary/secondary, 2 - detected by secondary only
#
