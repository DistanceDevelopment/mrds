...
#' @author Jeff Laake
prob.se <-
function(model,fct,vcov,observer=NULL,fittedmodel=NULL)
#
#  prob.se - computes std error of an average parameter value weighted based
#            on empirical covariate distribution
#
#  Arguments:
#
#  model          - ddf model object
#  fct            - generic fct to compute parameter values
...
#
   ...
   else
   {
    ...
    return(list(var=vc1+vc2,partial=vc1.list$partial,covar=covar))
}
