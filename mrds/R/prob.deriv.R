...
#' @author Jeff Laake
prob.deriv <-
function(par,model,parfct,observer=NULL,fittedmodel=NULL)
#
# prob.deriv - used in call to DeltaMethod from prob.se to
...
# parfct      - generic function being averaged- avgp or avgp0 (see summary.*.r)
