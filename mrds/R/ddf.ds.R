...
#' @author Jeff Laake
#' @seealso \code{\link{flnl}},
#'   \code{\link{summary.ds}},\code{\link{coef.ds}},\code{\link{plot.ds}},\code{\link{gof.ds}}
...
#' result=ddf(dsmodel = ~mcds(key = "hn", formula = ~1), data = egdata[egdata$observer == 
...
#
#  jll 18-Nov-04 added code to remove observations with missing distance
#  jll 2-June-05 need to allow for grouped data
#  dlm 6-July-05 commented out all logistic/p(0) stuff to start work with adjustment terms
...
#  fix: jll 18-Nov-04 - added braces so code would work as intended to add detected if missing
#
