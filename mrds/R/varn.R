...
#' \tabular{ll}{ \code{R2} \tab random line placement with unequal line lengths
#' (design-assisted estimator) \cr \code{R3} \tab random line placement,
#' model-assisted estimator, based on true contagion process \cr \code{R4} \tab
#' random line placement, model-assisted estimator, based on apparent contagion
#' process \cr \code{S1} \tab systematic line placement, post-stratification
#' with no strata overlap \cr \code{S2} \tab systematic line placement,
#' post-stratification with no strata overlap, variances weighted by line
#' length per stratum \cr \code{O1} \tab systematic line placement,
#' post-stratification with overlapping strata (akin to S1) \cr \code{O2} \tab
#' systematic line placement, post-stratification with overlapping strata
#' (weighted by line length per stratum, akin to S2) \cr \code{O3} \tab
#' systematic line placement, post-stratification with overlapping strata,
#' model-assisted estimator with trend in encounter rate with line length \cr }
...
covn <-
function (lvec, groups1, groups2, type)
{
#
